...
// Higher-level Select component that accepts options
...
const SelectWithOptions = React.forwardRef<
  HTMLDivElement,
  SelectSharedProps
>(({ options, placeholder, value, defaultValue, onValueChange, disabled, hasError, ...props }, forwardedRef) => {
  return (
    <div ref={forwardedRef}>
      <Select value={value} defaultValue={defaultValue} onValueChange={onValueChange} disabled={disabled} {...props}>
